...
signed main()
{
  ...
  /*
  Access mode: private
  public members of base class have private access mode
  in derived class.
  */
  //cout<<m.age<<endl; //This will produce error
  m.setAge(22); //Modifying private members through setter
  cout<<m.getAge()<<endl; //Accessing private members through getter

  //---------------------------------------------------------

  /*
  Access mode: private
  protected members of base class have private access mode
  in derived class.
  */
  //cout<<m.weight<<endl;//This will produce error
  cout<<m.getWeight()<<endl; //Accessing private members through getter
