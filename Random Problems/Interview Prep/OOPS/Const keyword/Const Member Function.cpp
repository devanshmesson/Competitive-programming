class employee
{
 ...
 employee(string company, int age, char *name) 
  ...
  //setter (const function)
  //This produces error because The idea of const functions is not to allow them to modify the object on which they are called
  void setcompany(string comp,string password) const 
  {
...
signed main()
{
  ...
  devansh.setcompany("Google","abcd");
}
